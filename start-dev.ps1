...
Write-Host "Start Firestore-Emulator (Datastore-Mode) on Port $EmulatorPort ..." -ForegroundColor Cyan
...
Write-Host "Wait for the Emulator to start..." -ForegroundColor Cyan
